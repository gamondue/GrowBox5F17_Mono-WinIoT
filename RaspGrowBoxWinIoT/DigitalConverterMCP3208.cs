...
namespace AppRaspGrowBox
{
    class DigitalConverterMCP3208
    {
        ...
        public DigitalConverterMCP3208(SpiDeviceHandler sdh = null)
        {
            if (sdh == null) throw new Exception("SpiDeviceHandler non inizializzato.");
            _sdh = sdh;
        }
