...
{
    class CO2Sensor : DigitalConverterMCP3208
    {

        private int _ch;
        private double _voltSensore;

        public CO2Sensor(int ch, double voltSensore = 3.3, SpiDeviceHandler sdh = null) : base(sdh)
        {
            _ch = ch;
        ...
        public double Read()
        {
            ...
            double volts = ReadVolt(_ch, _voltSensore);
